...
$PAGE->set_url('/local/repositoryciae/element04.php?discussionid='.$discussionid);
$PAGE->set_context(context_system::instance());
...
if($mform->is_cancelled()){
    ...
    $toform = $DB->get_record('local_repositoryciae_answer', ['question'=>'suggestions','discussion_id'=>$discussionid, 'user_id'=>$USER->id]);
