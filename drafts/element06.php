...
$PAGE->set_url('/local/repositoryciae/element06.php?discussionid='.$discussionid);
$PAGE->set_context(context_system::instance());
...
if($mform->is_cancelled()){
    ...
    $toform = $DB->get_record('local_repositoryciae_answer', ['question'=>'axis','discussion_id'=>$discussionid, 'user_id'=>$USER->id]);
