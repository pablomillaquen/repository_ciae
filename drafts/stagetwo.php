...
$PAGE->set_url('/local/repositoryciae/stagetwo.php?discussionid='.$discussionid);
$PAGE->set_context(context_system::instance());

echo $OUTPUT->header();

require_once("../forms/stagetwodraft.php");
$mform = new stagetwodraft_form();
$toform = [];
if($mform->is_cancelled()){
    ...
    if($fromform->id != 0){        
        ...
        $newdraft->axis = $fromform->axis;
        $newdraft->learning = $fromform->learning;
        $newdraft->guidelines = $fromform->guidelines;
