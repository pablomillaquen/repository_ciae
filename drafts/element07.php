...
$PAGE->set_url('/local/repositoryciae/element07.php?discussionid='.$discussionid);
$PAGE->set_context(context_system::instance());
...
if($mform->is_cancelled()){
    ...
    if($fromform->id != 0){        
        ...
        $newdraft->answer = implode(",",$fromform->answer);
    ...
    $toform = $DB->get_record('local_repositoryciae_answer', ['question'=>'learning','discussion_id'=>$discussionid, 'user_id'=>$USER->id]);
    // print_r($toform);
    // exit;
