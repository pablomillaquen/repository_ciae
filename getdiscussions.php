 ...
 */
 ...
 class discussions_form extends moodleform
 {
    ...
    public function definition()
    {
        ...
        $sql = "SELECT d.* FROM forum_discussions d JOIN course c on d.course = c.id WHERE c.fullname = 'Materiales compartidos'";
        ...
        $sql2 = "SELECT d.* FROM forum_discussions d JOIN course c on d.course = c.id WHERE c.fullname = 'Validación de contenidos'";
