...
$culturalcontentlist = $DB->get_records("local_repositoryciae_cc");
...
foreach($culturalcontentlist as $oa){
...
$data->culturalcontentlist = array_values($culturalcontentlist);

$PAGE->set_url('/local/repositoryciae/culturalcontentlist.php');
...
echo $OUTPUT->render_from_template('local_repositoryciae/culturalcontentlist', $data);
