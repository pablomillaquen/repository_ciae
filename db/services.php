...
$services = array(
    'repositoryciaeservice' => array(                      //the name of the web service
        'functions' => array ('local_repositoryciae_submit_create_collab_form','local_repositoryciae_loadjson','local_repositoryciae_load_discussion_files'), //web service functions of this service
