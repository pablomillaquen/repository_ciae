 ...
 */
 ...
 class collabfile_form extends moodleform
 {
    ...
    public function definition()
    {
        ...
        $sel = $mform->addElement('select', 'grades', get_string('recomendedgrades', 'local_repositoryciae'), $optionsgrades, []);
        ...
        $select = $mform->addElement('select', 'grades', get_string('grades', 'local_repositoryciae'), $optionsgrades, []);
