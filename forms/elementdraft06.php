 ...
 */
 ...
 class elementdraft06_form extends moodleform
 {
    ...
    public function definition()
    {
        ...
        $mform->addElement('hidden', 'question', 'axis');
        ...
        $select3 = $mform->addElement('select', 'answer', get_string('axis', 'local_repositoryciae'), $optionsaxis, []);
